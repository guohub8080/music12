...
const MODE_META_MAP: Record<string, { type: string }> = {
...
export const getModeTypeByModeKey = (modeKey: string) => {
  const modeMeta = MODE_META_MAP[modeKey]
  if (!modeMeta) throw new Error("Invalid modeKey.")
  return modeMeta.type
}
