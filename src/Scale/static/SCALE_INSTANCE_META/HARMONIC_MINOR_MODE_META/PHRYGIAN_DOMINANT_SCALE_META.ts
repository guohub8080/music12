...
export default [
  {
    ...
    pianoKeyIds: [0, 1, 4, 5, 7, 8, 10],
    pianoKeyIdsSorted: [0, 1, 4, 5, 7, 8, 10],
    degreeToPianoKeyId: { 1: 0, 2: 1, 3: 4, 4: 5, 5: 7, 6: 8, 7: 10 },
    pianoKeyIdToDegree: { 0: 1, 1: 2, 2: null, 3: null, 4: 3, 5: 4, 6: null, 7: 5, 8: 6, 9: null, 10: 7, 11: null },
  ...
  },
  {
    pianoKeyIdRoot: 1,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [1, 2, 5, 6, 8, 9, 11],
    pianoKeyIdsSorted: [1, 2, 5, 6, 8, 9, 11],
    degreeToPianoKeyId: { 1: 1, 2: 2, 3: 5, 4: 6, 5: 8, 6: 9, 7: 11 },
    pianoKeyIdToDegree: { 0: null, 1: 1, 2: 2, 3: null, 4: null, 5: 3, 6: 4, 7: null, 8: 5, 9: 6, 10: null, 11: 7 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 2,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [2, 3, 6, 7, 9, 10, 0],
    pianoKeyIdsSorted: [0, 2, 3, 6, 7, 9, 10],
    degreeToPianoKeyId: { 1: 2, 2: 3, 3: 6, 4: 7, 5: 9, 6: 10, 7: 0 },
    pianoKeyIdToDegree: { 0: 7, 1: null, 2: 1, 3: 2, 4: null, 5: null, 6: 3, 7: 4, 8: null, 9: 5, 10: 6, 11: null },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 3,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [3, 4, 7, 8, 10, 11, 1],
    pianoKeyIdsSorted: [1, 3, 4, 7, 8, 10, 11],
    degreeToPianoKeyId: { 1: 3, 2: 4, 3: 7, 4: 8, 5: 10, 6: 11, 7: 1 },
    pianoKeyIdToDegree: { 0: null, 1: 7, 2: null, 3: 1, 4: 2, 5: null, 6: null, 7: 3, 8: 4, 9: null, 10: 5, 11: 6 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 4,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [4, 5, 8, 9, 11, 0, 2],
    pianoKeyIdsSorted: [0, 2, 4, 5, 8, 9, 11],
    degreeToPianoKeyId: { 1: 4, 2: 5, 3: 8, 4: 9, 5: 11, 6: 0, 7: 2 },
    pianoKeyIdToDegree: { 0: 6, 1: null, 2: 7, 3: null, 4: 1, 5: 2, 6: null, 7: null, 8: 3, 9: 4, 10: null, 11: 5 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 5,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [5, 6, 9, 10, 0, 1, 3],
    pianoKeyIdsSorted: [0, 1, 3, 5, 6, 9, 10],
    degreeToPianoKeyId: { 1: 5, 2: 6, 3: 9, 4: 10, 5: 0, 6: 1, 7: 3 },
    pianoKeyIdToDegree: { 0: 5, 1: 6, 2: null, 3: 7, 4: null, 5: 1, 6: 2, 7: null, 8: null, 9: 3, 10: 4, 11: null },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 6,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [6, 7, 10, 11, 1, 2, 4],
    pianoKeyIdsSorted: [1, 2, 4, 6, 7, 10, 11],
    degreeToPianoKeyId: { 1: 6, 2: 7, 3: 10, 4: 11, 5: 1, 6: 2, 7: 4 },
    pianoKeyIdToDegree: { 0: null, 1: 5, 2: 6, 3: null, 4: 7, 5: null, 6: 1, 7: 2, 8: null, 9: null, 10: 3, 11: 4 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 7,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [7, 8, 11, 0, 2, 3, 5],
    pianoKeyIdsSorted: [0, 2, 3, 5, 7, 8, 11],
    degreeToPianoKeyId: { 1: 7, 2: 8, 3: 11, 4: 0, 5: 2, 6: 3, 7: 5 },
    pianoKeyIdToDegree: { 0: 4, 1: null, 2: 5, 3: 6, 4: null, 5: 7, 6: null, 7: 1, 8: 2, 9: null, 10: null, 11: 3 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 8,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [8, 9, 0, 1, 3, 4, 6],
    pianoKeyIdsSorted: [0, 1, 3, 4, 6, 8, 9],
    degreeToPianoKeyId: { 1: 8, 2: 9, 3: 0, 4: 1, 5: 3, 6: 4, 7: 6 },
    pianoKeyIdToDegree: { 0: 3, 1: 4, 2: null, 3: 5, 4: 6, 5: null, 6: 7, 7: null, 8: 1, 9: 2, 10: null, 11: null },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 9,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [9, 10, 1, 2, 4, 5, 7],
    pianoKeyIdsSorted: [1, 2, 4, 5, 7, 9, 10],
    degreeToPianoKeyId: { 1: 9, 2: 10, 3: 1, 4: 2, 5: 4, 6: 5, 7: 7 },
    pianoKeyIdToDegree: { 0: null, 1: 3, 2: 4, 3: null, 4: 5, 5: 6, 6: null, 7: 7, 8: null, 9: 1, 10: 2, 11: null },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 10,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [10, 11, 2, 3, 5, 6, 8],
    pianoKeyIdsSorted: [2, 3, 5, 6, 8, 10, 11],
    degreeToPianoKeyId: { 1: 10, 2: 11, 3: 2, 4: 3, 5: 5, 6: 6, 7: 8 },
    pianoKeyIdToDegree: { 0: null, 1: null, 2: 3, 3: 4, 4: null, 5: 5, 6: 6, 7: null, 8: 7, 9: null, 10: 1, 11: 2 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
  ...
  },
  {
    pianoKeyIdRoot: 11,
    scaleModeId: SCALE_MODE_ID.PhrygianDominant,
    pianoKeyIds: [11, 0, 3, 4, 6, 7, 9],
    pianoKeyIdsSorted: [0, 3, 4, 6, 7, 9, 11],
    degreeToPianoKeyId: { 1: 11, 2: 0, 3: 3, 4: 4, 5: 6, 6: 7, 7: 9 },
    pianoKeyIdToDegree: { 0: 2, 1: null, 2: null, 3: 3, 4: 4, 5: null, 6: 5, 7: 6, 8: null, 9: 7, 10: null, 11: 1 },
    degreeAlterationsMap: { 2: -1, 3: 0, 4: 0, 5: 0, 6: -1, 7: -1 },
    scaleMode: {
      scaleModeId: SCALE_MODE_ID.PhrygianDominant,
      intervalList: [
