// 类型导出
export type { I_ScaleModeMeta } from "./types.ts"
...
// 和声大调族
export { HARMONIC_MAJOR_MODE_META } from "./FAMILIES/HARMONIC_MAJOR_MODE_META.ts"

// 旋律大调族
export { MELODIC_MAJOR_DESCENDING_MODE_META } from "./FAMILIES/MELODIC_MAJOR_MODE_META.ts"
