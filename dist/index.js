...
__export(index_exports, {
  Radix: () => radix_exports,
  chord: () => chord_default,
  circleOfFifths: () => circleOfFifths_exports,
  factory: () => factory_exports,
  find: () => find_default,
  interval: () => interval_exports,
  note: () => note_exports,
  scale: () => scale_default,
  stave: () => stave_exports
});
...
var Base7Radix = class _Base7Radix extends Radix {
  ...
  static fromArray(array) {
    ...
    if (!(0, import_lodash.isNumber)(array[0])) throw new RadixError("The first digit of the array must be a number.");
...
var Base12Radix = class _Base12Radix extends Radix {
  ...
  static fromArray(array) {
    ...
    if (!(0, import_lodash2.isNumber)(array[0])) throw new RadixError("The first digit of the array must be a number.");
...
var noteMeta_default = (0, import_collect.default)(
  [
    {
      uid: 1,
      artName: "C",
...
var StepRadix = class _StepRadix extends Base7Radix {
  constructor(step) {
    if ((0, import_lodash3.isNumber)(step))
      super(step);
    else
  ...
  static fromArray(array) {
    ...
    if (!(0, import_lodash3.isNumber)(array[0])) throw new RadixError("The first digit of the array must be a number.");
    if ((0, import_lodash3.isString)(array[1])) {
      try {
    ...
    if ((0, import_lodash3.isNumber)(array[1])) {
...
var SemitoneRadix = class _SemitoneRadix extends Base12Radix {
  ...
  getKeyboardNotes(isAlterAbsLessThan) {
    if ((0, import_lodash3.isUndefined)(isAlterAbsLessThan) || (0, import_lodash3.isNull)(isAlterAbsLessThan)) return noteMeta_default.where("locationId", this.location).all();
...
var cls_getNoteByInterval_default = (noteInstance, intervalInstance, isAscending = true) => {
  if ((0, import_lodash4.isUndefined)(intervalInstance) || (0, import_lodash4.isNull)(intervalInstance)) throw new IntervalError("Interval is empty.");
  if ((0, import_lodash4.isUndefined)(noteInstance) || (0, import_lodash4.isNull)(noteInstance)) throw new NoteError("Note is empty.");
...
var cls_getSamePitchNotes_default = (givenNoteInstance, isSelfIncluded = true, alterAbsLessThan = 2) => {
  ...
  const result = [];
  const alterList = (0, import_lodash5.range)(alterAbsLessThan * -1, alterAbsLessThan + 1);
...
var import_chinese_numbering = require("chinese-numbering");

// src/interval/static/intervalMeta.ts
var import_collect2 = __toESM(require("collect.js"));
var intervalMeta_default = (0, import_collect2.default)(
  [
    {
      type: "aug+",
      num: 1,
...
var Interval = class {
  ...
  get simpleDescription() {
    return `${this.cnPrefix}${(0, import_chinese_numbering.numberToChinese)(this.num, { chineseType: "simplified" })}\u5EA6`;
  }
...
var cls_semitoneMove = (noteInstance, moveStep) => {
  ...
  const findZeroAlterNote = (0, import_collect3.default)(notesInfoList).where("isNormal", true).where("alter", 0).first();
  if (!(0, import_lodash6.isUndefined)(findZeroAlterNote)) {
    return new Note(findZeroAlterNote.step, findZeroAlterNote.alter, endSemitoneRadix.octave);
  }
  if (moveStep > 0) {
    const findSharpNote = (0, import_collect3.default)(notesInfoList).where("isNormal", true).where("alter", ">", 0).first();
    return new Note(findSharpNote.step, findSharpNote.alter, endSemitoneRadix.octave);
  }
  const findFlatNote = (0, import_collect3.default)(notesInfoList).where("isNormal", true).where("alter", "<", 0).first();
...
var import_collect4 = __toESM(require("collect.js"));

// src/common/utils/byDefault.ts
var import_lodash7 = require("lodash");
var byDefault = (input, defaultValue) => {
  if ((0, import_lodash7.isNull)(input) || (0, import_lodash7.isUndefined)(input)) return defaultValue;
  return input;
};
...
var dealOctave = (octave = 4) => {
  if ((0, import_lodash8.isNumber)(octave)) return octave;
  if ((0, import_lodash8.isArray)(octave)) {
    const a = (0, import_collect4.default)(octave).random();
    if ((0, import_lodash8.isNumber)(a)) return a;
...
var getNoteByLocation = (location, octave) => {
  if (!(0, import_lodash8.range)(12).includes(location)) throw new Error("location must be in range of 0 - 11.");
...
var getIntervalBySemitoneGap = (semitoneGap) => {
  ...
  if ((0, import_lodash9.isUndefined)(findResult) || (0, import_lodash9.isNumber)(findResult)) return [];
...
var import_collect5 = __toESM(require("collect.js"));
var cls_initScale_default = (rootNote, scaleMode = "MAJ") => {
  ...
  const findModeObj = (0, import_collect5.default)(modeMeta_default).where("uid", modeName).first();
  if (!findModeObj) {
...
var cls_getIntervalList = (intervalPanel) => {
  const result = [];
  for (const i of (0, import_lodash10.keys)(intervalPanel)) {
...
var import_collect6 = __toESM(require("collect.js"));
...
var cls_findOneChordInScale = (notesList, scaleDegree, isChord3) => {
  ...
  const findObj = (0, import_collect6.default)(findChordMeta_default).filter((x) => {
    return (0, import_lodash11.isEqual)(x.notesLocationList, notesLocationList);
  }).first();
  if ((0, import_lodash11.isEmpty)(findObj)) throw new ChordError(`No such chord.`);
...
var cls_findDegreeChordInScale = (notesList, isChord3) => {
  ...
  return (0, import_lodash12.range)(7).map((x) => cls_findOneChordInScale_default(notesList, x + 1, isChord3));
};
...
var import_collect7 = __toESM(require("collect.js"));
var cls_initChordClass = (chordKey) => {
  const findChordObj = (0, import_collect7.default)(chordMeta_default).where("chordKey", chordKey).first();
...
var cls_getIntervalPanel = (baseIntervalPanel, transformPanel) => {
  ...
  for (const i_key of (0, import_lodash13.keys)(baseIntervalPanel)) {
...
var cls_getNotesList2 = (rootNote, intervalPanel) => {
  ...
  for (const i_key of (0, import_lodash14.keys)(intervalPanel)) {
...
var cls_getNotesPanel2 = (rootNote, intervalPanel) => {
  ...
  for (const i_key of (0, import_lodash15.keys)(intervalPanel)) {
    if (!intervalPanel[i_key]) continue;
    switch (i_key) {
      case "2":
...
var cls_getIntervalList2 = (intervalPanel) => {
  const resultList = [];
  for (const i of (0, import_lodash16.keys)(intervalPanel)) {
...
var cls_getScoreSymbol = (rootNote, baseScoreSymbol, baseIntervalPanel, transformPanel) => {
  const omitResults = [];
  const alterResults = [];
  for (const i_key of (0, import_lodash17.keys)(baseIntervalPanel)) {
    if ((0, import_lodash17.isEmpty)(transformPanel[i_key])) continue;
    if (transformPanel[i_key] === "omit") {
...
var cls_isTransformEmpty = (obj) => {
  let result = true;
  for (let k of (0, import_lodash18.keys)(obj)) {
    if (!(0, import_lodash18.isUndefined)(obj[k])) {
      result = false;
      break;
    }
  }
...
// src/chord/cls/classFn/cls_tryToMergeTransform.ts
var import_collect8 = __toESM(require("collect.js"));
var cls_tryToMergeTransform = (rootNote, chordKey, intervalPanel, transformPanel) => {
  ...
  for (let k of (0, import_lodash19.keys)(transformPanel)) {
    const tk = transformPanel[k];
    if (!(0, import_lodash19.isString)(tk)) continue;
    if (tk === "omit") {
  ...
  const findSemitoneList = (0, import_lodash19.keys)(newIntervalPanel).map((k) => {
    if (!(0, import_lodash19.isEmpty)(newIntervalPanel[k])) {
      return getInterval(newIntervalPanel[k], parseInt(k, 10));
    }
  }).filter(Boolean).map((x) => x.semitoneLocation).sort((a, b) => a - b);
  const findNewResult = (0, import_collect8.default)(chordMeta_default).filter((x) => {
    if ((0, import_lodash19.isEqual)(x.orderedSemitoneLocationList, findSemitoneList)) return true;
  }).first();
  if ((0, import_lodash19.isEmpty)(findNewResult)) return new Chord(rootNote, chordKey, transformPanel);
...
var Chord = class {
  constructor(rootNote, chordKey, initTransform) {
    ...
    __privateSet(this, _transformPanel, (0, import_lodash20.isEmpty)(initTransform) ? defaultTransform : { ...defaultTransform, ...initTransform });
  }
  tryToMergeTransform() {
...
var import_collect9 = __toESM(require("collect.js"));
var getModeNameByModeKey = (modeKey) => {
  try {
    return (0, import_collect9.default)(modeMeta_default).where("uid", modeKey).first().name;
  } catch (e) {
...
var import_collect10 = __toESM(require("collect.js"));
var getModeNameByModeKey2 = (modeKey) => {
  try {
    return (0, import_collect10.default)(modeMeta_default).where("uid", modeKey).first().type;
  } catch (e) {
    throw new Error("The modeKey is not valid!");
  }
};
...
var import_collect11 = __toESM(require("collect.js"));
var import_lodash21 = require("lodash");
var getIntervalListByModeKey = (modeKey) => {
  const findResult = (0, import_collect11.default)(modeMeta_default).where("uid", modeKey).first();
  if ((0, import_lodash21.isEmpty)(findResult)) throw new Error(`Error Mode of ${modeKey}.`);
...
var import_collect12 = __toESM(require("collect.js"));
var fifthMeta_default = (0, import_collect12.default)(
  [
    {
      rawNoteStep: "C",
      rawNoteAlter: -1,
...
var getStaveAlterByNote = (step, alter) => {
  ...
  if ((0, import_lodash22.isEmpty)(findObj)) throw new Error("No alter value found for the given note!");
  return findObj;
};
...
var liReverse = (0, import_lodash23.reverse)([...li]);
...
var CircleOfFifths = class _CircleOfFifths extends Base12Radix {
  constructor(i = 0) {
    if (!(0, import_lodash24.isInteger)(i)) throw new CircleOfFifthsError("given number must be integer");
    super(i);
  }
  get majCircle() {
  ...
  move(num) {
    if (!(0, import_lodash24.isInteger)(num)) throw new CircleOfFifthsError("num must be integer");
...
var import_collect13 = __toESM(require("collect.js"));
var import_lodash25 = require("lodash");
var findChord = (locationList, isStrictlyMatch, rootNoteLocation, limitType) => {
  const isLimitType = (0, import_lodash25.isArray)(limitType) && limitType.length > 0;
  const betterLocationList = locationList.slice().sort((x, y) => x - y);
  const isRootNoteLocationRequired = (0, import_lodash25.isNumber)(rootNoteLocation) && rootNoteLocation >= 0 && rootNoteLocation <= 11;
  let handle = (0, import_collect13.default)(findChordMeta_default);
  ...
  if (isStrictlyMatchJudge) {
    const result2 = handle.filter((x) => (0, import_lodash25.isEqual)(betterLocationList, x.orderedNotesLocationList)).all();
    if ((0, import_lodash25.isEmpty)(result2)) return [];
    return result2;
  }
  const result = handle.filter((x) => {
    if ((0, import_lodash25.isEqual)(betterLocationList, x.orderedNotesLocationList)) return true;
    if (x.orderedNotesLocationList.length > betterLocationList.length) {
      if ((0, import_lodash25.intersection)(betterLocationList, x.orderedNotesLocationList).length === betterLocationList.length) return true;
    }
  }).all();
  if ((0, import_lodash25.isEmpty)(result)) return [];
  return result;
};
var findChord_default = findChord;

// src/find/findChordInScale.ts
var import_collect14 = __toESM(require("collect.js"));
...
var findChordInScale = (locationListOfChord, limitMode) => {
  let findScaleHandle = (0, import_collect14.default)(findScale_default).filter((x) => {
    return (0, import_lodash26.intersection)(x.notesLocationList, locationListOfChord).length === locationListOfChord.length;
  });
  if ((0, import_lodash26.isString)(limitMode)) {
    findScaleHandle = findScaleHandle.filter((x) => {
      return x.mode === limitMode;
    });
  } else if ((0, import_lodash26.isArray)(limitMode)) {
    findScaleHandle = findScaleHandle.filter((x) => {
      return limitMode.includes(x.mode);
    });
  }
  const findScaleObj = findScaleHandle.all();
  if ((0, import_lodash26.isEmpty)(findScaleObj)) return [];
  return findScaleObj;
};
var findChordInScale_default = findChordInScale;

// src/chord/methods/getChordSymbolByKey.ts
var import_collect15 = __toESM(require("collect.js"));
var getChordSymbolByKey = (k) => {
  return (0, import_collect15.default)(chordMeta_default).where("chordKey", k).first().scoreDisplay;
};
var getChordSymbolByKey_default = getChordSymbolByKey;

// src/chord/methods/getChordCnNameByKey.ts
var import_collect16 = __toESM(require("collect.js"));
var getChordCnNameByKey = (k) => {
  return (0, import_collect16.default)(chordMeta_default).where("chordKey", k).first().cnName;
};
...
var getChordTransformByLocationList = (originChordInfo, chordNotesLocationList) => {
  ...
  const standardChordNotesLocationList = (0, import_lodash27.keys)(originChordInfo).map((x) => originChordInfo[x]).filter((x) => x !== -1);
  const intersectionList = (0, import_lodash27.intersection)(standardChordNotesLocationList, chordNotesLocationList);
  ...
  if ((0, import_lodash27.isNumber)(originChordInfo.n3L) && originChordInfo.n3L >= 0) {
    if (standardAfterSubtract.includes(originChordInfo.n3L)) {
      adjustObj.omit.push(3);
    }
  }
  if ((0, import_lodash27.isNumber)(originChordInfo.n5L) && originChordInfo.n5L >= 0) {
    if (standardAfterSubtract.includes(originChordInfo.n5L)) {
      adjustObj.omit.push(5);
    }
  }
  if ((0, import_lodash27.isNumber)(originChordInfo.n7L) && originChordInfo.n7L >= 0) {
    if (standardAfterSubtract.includes(originChordInfo.n7L)) {
      adjustObj.omit.push(7);
    }
  }
  if ((0, import_lodash27.isNumber)(originChordInfo.n9L) && originChordInfo.n9L >= 0) {
    if (standardAfterSubtract.includes(originChordInfo.n9L)) {
      adjustObj.omit.push(9);
    }
  }
  if ((0, import_lodash27.isNumber)(originChordInfo.n11L) && originChordInfo.n11L >= 0) {
    if (standardAfterSubtract.includes(originChordInfo.n11L)) {
      adjustObj.omit.push(11);
    }
  }
  if ((0, import_lodash27.isNumber)(originChordInfo.n13L) && originChordInfo.n13L >= 0) {
...
var import_collect17 = __toESM(require("collect.js"));
var import_lodash28 = require("lodash");
var findNotesInChord = (notesList) => {
  let findHandle = (0, import_collect17.default)(findChordMeta_default);
  ...
  if ((0, import_lodash28.isEmpty)(findObj)) return [];
  return findObj;
};
...
var import_collect18 = __toESM(require("collect.js"));
var import_lodash29 = require("lodash");
var findNotesInScale = (notesList) => {
  let findHandle = (0, import_collect18.default)(findScale_default);
  for (const x of notesList) {
  ...
  const findObj = findHandle.all();
  if ((0, import_lodash29.isEmpty)(findObj)) return [];
  return findObj;
};
...
var import_collect19 = __toESM(require("collect.js"));
var findComplexChordByMidi = (midiPitchList) => {
  const locationList = (0, import_lodash30.sortBy)((0, import_lodash30.uniq)(midiPitchList.map((x) => new Base12Radix(x).lastDigit)));
  const findResult = (0, import_collect19.default)(findChordMeta_default).where("orderedNotesLocationList", "!==", locationList).filter((x) => {
    ...
    return (0, import_lodash30.intersection)(x.orderedNotesLocationList, locationList).length > 2;
  });
  if ((0, import_lodash30.isUndefined)(findResult) || (0, import_lodash30.isNull)(findResult) || (0, import_lodash30.isArray)(findResult) && findResult.length === 0) {
    return [];
  }
  ...
  return (0, import_lodash30.orderBy)(originMapList, "likely", "desc");
};
var findComplexChordByMidi_default = findComplexChordByMidi;
var jaccard = (a, b) => {
  const intersectionLength = (0, import_lodash30.intersection)(a, b).length;
